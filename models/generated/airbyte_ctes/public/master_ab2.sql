...
select
    ...
    cast(date_time_closed as {{ dbt_utils.type_timestamp() }}) as date_time_closed,
    cast(date_time_opened as {{ dbt_utils.type_timestamp() }}) as date_time_opened,
